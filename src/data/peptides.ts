...
export const PEPTIDES: Peptide[] = [
  ...
  },
  {
    ...
    category: 'glp1',
    halfLifeHours: 144,
    mechanismShort: 'Triple agonist: GIP/GLP-1/glucagon receptors. Most potent weight loss peptide in trials (up to 24% body weight).',
    route: 'subq',
    needleGauge: '30-31G insulin',
    dosing: {
      low: 1,
      ...
      withFood: 'either',
      titration: [
        { weekStart: 1, weekEnd: 4, dose: 1, unit: 'mg' },
        { weekStart: 5, weekEnd: 8, dose: 2, unit: 'mg' },
        { weekStart: 9, weekEnd: 12, dose: 4, unit: 'mg' },
        { weekStart: 13, weekEnd: 16, dose: 8, unit: 'mg' },
    ...
    cyclingReason: 'Still in clinical trials. Follow titration strictly. Monitor liver enzymes.',
  },
  {
    id: 'cjc-1295-no-dac',
